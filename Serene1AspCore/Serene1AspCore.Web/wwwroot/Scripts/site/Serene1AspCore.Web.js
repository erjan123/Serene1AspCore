...
(function (Serene1AspCore) {
    ...
    })(Administration = Serene1AspCore.Administration || (Serene1AspCore.Administration = {}));
})(Serene1AspCore || (Serene1AspCore = {}));
var Serene1AspCore;
(function (Serene1AspCore) {
    var Administration;
    (function (Administration) {
...
(function (Serene1AspCore) {
    ...
    })(BasicSamples = Serene1AspCore.BasicSamples || (Serene1AspCore.BasicSamples = {}));
})(Serene1AspCore || (Serene1AspCore = {}));
var Serene1AspCore;
(function (Serene1AspCore) {
    var BasicSamples;
        ...
        var FilteredLookupInDetailForm = /** @class */ (function (_super) {
            ...
            function FilteredLookupInDetailForm(prefix) {
                ...
                if (!FilteredLookupInDetailForm.init) {
                    ...
                    var s = Serenity;
                    var w0 = Serene1AspCore.Northwind.CustomerEditor;
                    var w1 = s.DateEditor;
        ...
        var PopulateLinkedDataForm = /** @class */ (function (_super) {
            ...
            function PopulateLinkedDataForm(prefix) {
                ...
                if (!PopulateLinkedDataForm.init) {
                    ...
                    var w2 = s.DateEditor;
                    var w3 = s.LookupEditor;
                    var w4 = Serene1AspCore.Northwind.OrderDetailsEditor;
        ...
        var StaticTextBlockForm = /** @class */ (function (_super) {
            ...
            function StaticTextBlockForm(prefix) {
                ...
                if (!StaticTextBlockForm.init) {
                    ...
                    var s = Serenity;
                    var w0 = Serene1AspCore.StaticTextBlock;
                    var w1 = s.StringEditor;
...
(function (Serene1AspCore) {
    ...
    })(Common = Serene1AspCore.Common || (Serene1AspCore.Common = {}));
})(Serene1AspCore || (Serene1AspCore = {}));
var Serene1AspCore;
(function (Serene1AspCore) {
    var Common;
...
(function (Serene1AspCore) {
    ...
    })(Membership = Serene1AspCore.Membership || (Serene1AspCore.Membership = {}));
})(Serene1AspCore || (Serene1AspCore = {}));
var Serene1AspCore;
(function (Serene1AspCore) {
    var Membership;
...
(function (Serene1AspCore) {
    ...
    })(Northwind = Serene1AspCore.Northwind || (Serene1AspCore.Northwind = {}));
})(Serene1AspCore || (Serene1AspCore = {}));
var Serene1AspCore;
(function (Serene1AspCore) {
    var Northwind;
...
(function (Serene1AspCore) {
    ...
    (function (Northwind) {
        ...
        Serenity.Decorators.registerEnumType(Gender, 'Serene1AspCore.Northwind.Gender', 'Serene1AspCore.Northwind.Entities.Gender');
    })(Northwind = Serene1AspCore.Northwind || (Serene1AspCore.Northwind = {}));
})(Serene1AspCore || (Serene1AspCore = {}));
var Serene1AspCore;
(function (Serene1AspCore) {
...
(function (Serene1AspCore) {
    ...
    (function (LanguageList) {
        function getValue() {
            var result = [];
            for (var _i = 0, _a = Serene1AspCore.Administration.LanguageRow.getLookup().items; _i < _a.length; _i++) {
                var k = _a[_i];
                if (k.LanguageId !== 'en') {
    ...
    })(LanguageList = Serene1AspCore.LanguageList || (Serene1AspCore.LanguageList = {}));
})(Serene1AspCore || (Serene1AspCore = {}));
...
(function (Serene1AspCore) {
    ...
    (function (ScriptInitialization) {
        ...
        Serenity.EntityDialog.defaultLanguageList = Serene1AspCore.LanguageList.getValue;
        if ($.fn['colorbox']) {
            $.fn['colorbox'].settings.maxWidth = "95%";
            $.fn['colorbox'].settings.maxHeight = "95%";
        }
        window.onerror = Q.ErrorHandling.runtimeErrorHandler;
    })(ScriptInitialization = Serene1AspCore.ScriptInitialization || (Serene1AspCore.ScriptInitialization = {}));
})(Serene1AspCore || (Serene1AspCore = {}));
var Serene1AspCore;
(function (Serene1AspCore) {
    var Administration;
...
(function (Serene1AspCore) {
    ...
    Serene1AspCore.BasicProgressDialog = BasicProgressDialog;
})(Serene1AspCore || (Serene1AspCore = {}));
var Serene1AspCore;
(function (Serene1AspCore) {
    var Common;
    (function (Common) {
        var BulkServiceAction = /** @class */ (function () {
            ...
            BulkServiceAction.prototype.createProgressDialog = function () {
                this.progressDialog = new Serene1AspCore.BasicProgressDialog();
...
(function (Serene1AspCore) {
    ...
    })(DialogUtils = Serene1AspCore.DialogUtils || (Serene1AspCore.DialogUtils = {}));
})(Serene1AspCore || (Serene1AspCore = {}));
var Serene1AspCore;
(function (Serene1AspCore) {
    var Common;
...
(function (Serene1AspCore) {
    ...
    Serene1AspCore.StaticTextBlock = StaticTextBlock;
})(Serene1AspCore || (Serene1AspCore = {}));
var Serene1AspCore;
(function (Serene1AspCore) {
    var Common;
    ...
    (function (Northwind) {
        var CustomerDialog = /** @class */ (function (_super) {
            ...
            function CustomerDialog() {
                ...
                Serene1AspCore.DialogUtils.pendingChangesConfirmation(_this.element, function () { return _this.getSaveState() != _this.loadedState; });
                return _this;
            }
    ...
    (function (Northwind) {
        var CustomerGrid = /** @class */ (function (_super) {
            ...
            CustomerGrid.prototype.getButtons = function () {
                ...
                buttons.push(Serene1AspCore.Common.ExcelExportHelper.createToolButton({
                    grid: this,
                    onViewSubmit: function () { return _this.onViewSubmit(); },
                    service: 'Northwind/Customer/ListExcel',
                    separator: true
                }));
                buttons.push(Serene1AspCore.Common.PdfExportHelper.createToolButton({
                    grid: this,
                    onViewSubmit: function () { return _this.onViewSubmit(); }
                }));
                return buttons;
    ...
    (function (Northwind) {
        var OrderDialog = /** @class */ (function (_super) {
            ...
            OrderDialog.prototype.getToolbarButtons = function () {
                var _this = this;
                var buttons = _super.prototype.getToolbarButtons.call(this);
                buttons.push(Serene1AspCore.Common.ReportHelper.createToolButton({
                    title: 'Invoice',
                    cssClass: 'export-pdf-button',
            ...
            OrderGrid.prototype.onClick = function (e, row, cell) {
                ...
                if (target.hasClass('inline-action')) {
                    ...
                    if (target.hasClass('print-invoice')) {
                        Serene1AspCore.Common.ReportHelper.execute({
                            reportKey: 'Northwind.OrderDetail',
                            params: {
            ...
            NotesEditor.prototype.addClick = function () {
                ...
                dlg.okClick = function () {
                    ...
                    Q.insert(_this.items, 0, {
                        Text: text,
                        InsertUserDisplayName: Serene1AspCore.Authorization.userDefinition.DisplayName,
...
(function (Serene1AspCore) {
    ...
    (function (Northwind) {
        ...
        }(Serene1AspCore.Common.GridEditorDialog));
...
(function (Serene1AspCore) {
    ...
    (function (Northwind) {
        ...
        }(Serene1AspCore.Common.GridEditorBase));
    ...
    (function (Northwind) {
        var RegionDialog = /** @class */ (function (_super) {
            ...
            RegionDialog.prototype.getLanguages = function () {
                return Serene1AspCore.LanguageList.getValue();
            };
...
(function (Serene1AspCore) {
    ...
    })(Authorization = Serene1AspCore.Authorization || (Serene1AspCore.Authorization = {}));
})(Serene1AspCore || (Serene1AspCore = {}));
var Serene1AspCore;
(function (Serene1AspCore) {
    var BasicSamples;
...
(function (Serene1AspCore) {
    ...
    (function (BasicSamples) {
        ...
        }(Serene1AspCore.Northwind.ProductDialog));
...
(function (Serene1AspCore) {
    ...
    (function (BasicSamples) {
        ...
        }(Serene1AspCore.Northwind.ProductGrid));
...
(function (Serene1AspCore) {
    ...
    (function (BasicSamples) {
        var DefaultValuesInNewGrid = /** @class */ (function (_super) {
            ...
            DefaultValuesInNewGrid.prototype.addButtonClick = function () {
                this.editItem({
                    ...
                    EmployeeID: Serene1AspCore.Northwind.EmployeeRow.getLookup().items
                        .filter(function (x) { return x.FullName === 'Robert King'; })[0].EmployeeID,
                    ShipVia: Serene1AspCore.Northwind.ShipperRow.getLookup().items
            ...
            DefaultValuesInNewGrid.prototype.getButtons = function () {
                ...
                buttons.push({
                    ...
                    onClick: function () {
                        ...
                        var dlg = new Serene1AspCore.Northwind.OrderDialog();
                        ...
                        var chai = Serene1AspCore.Northwind.ProductRow.getLookup().items
                            .filter(function (x) { return x.ProductName === 'Chai'; })[0];
                        // LoadEntityAndOpenDialog, loads an OrderRow 
                        // to dialog and opens it
                        var lauraCallahanID = Serene1AspCore.Northwind.EmployeeRow.getLookup().items
        ...
        }(Serene1AspCore.Northwind.OrderGrid));
...
(function (Serene1AspCore) {
    ...
    (function (BasicSamples) {
        ...
        }(Serene1AspCore.Northwind.OrderDialog));
...
(function (Serene1AspCore) {
    ...
    (function (BasicSamples) {
        var GetInsertedRecordIdDialog = /** @class */ (function (_super) {
            ...
            GetInsertedRecordIdDialog.prototype.onSaveSuccess = function (response) {
                ...
                if (this.isNew()) {
                    ...
                    Serene1AspCore.Northwind.CategoryService.Retrieve({
        ...
        }(Serene1AspCore.Northwind.CategoryDialog));
...
(function (Serene1AspCore) {
    ...
    (function (BasicSamples) {
        ...
        }(Serene1AspCore.Northwind.CategoryGrid));
        ...
        var OtherFormInTabDialog = /** @class */ (function (_super) {
            ...
            function OtherFormInTabDialog() {
                ...
                _this.customerPropertyGrid = new Serenity.PropertyGrid(_this.byId("CustomerPropertyGrid"), {
                    ...
                    items: Q.getForm(Serene1AspCore.Northwind.CustomerForm.formKey).filter(function (x) { return x.name != 'CustomerID'; }),
                    useCategories: true
                });
                // this is just a helper to access editors if needed
                _this.customerForm = new Serene1AspCore.Northwind.CustomerForm(_this.customerPropertyGrid.idPrefix);
                ...
                new Serenity.Toolbar(_this.byId("CustomerToolbar"), {
                    buttons: [{
                            ...
                            onClick: function () {
                                ...
                                Serene1AspCore.Northwind.CustomerService.Update({
                                    EntityId: id,
                                    Entity: c
                                }, function (response) {
                                    // reload customer list just in case
                                    Q.reloadLookup(Serene1AspCore.Northwind.CustomerRow.lookupKey);
                ...
                _this.form.CustomerID.change(function (e) {
                    ...
                    Serene1AspCore.Northwind.CustomerService.Retrieve({
                        EntityId: customerID
                    }, function (response) {
            ...
            OtherFormInTabDialog.prototype.getCustomerID = function () {
                ...
                return Q.first(Serene1AspCore.Northwind.CustomerRow.getLookup().items, function (x) { return x.CustomerID == customerID; }).ID;
            };
        ...
        var PopulateLinkedDataDialog = /** @class */ (function (_super) {
            ...
            function PopulateLinkedDataDialog() {
                ...
                _this.form.CustomerID.changeSelect2(function (e) {
                    ...
                    var id = Q.first(Serene1AspCore.Northwind.CustomerRow.getLookup().items, function (x) { return x.CustomerID == customerID; }).ID;
                    Serene1AspCore.Northwind.CustomerService.Retrieve({
                        EntityId: id
                    }, function (response) {
            ...
            PopulateLinkedDataDialog.prototype.getIdProperty = function () { return Serene1AspCore.Northwind.OrderRow.idProperty; };
            PopulateLinkedDataDialog.prototype.getLocalTextPrefix = function () { return Serene1AspCore.Northwind.OrderRow.localTextPrefix; };
            PopulateLinkedDataDialog.prototype.getNameProperty = function () { return Serene1AspCore.Northwind.OrderRow.nameProperty; };
            PopulateLinkedDataDialog.prototype.getService = function () { return Serene1AspCore.Northwind.OrderService.baseUrl; };
...
(function (Serene1AspCore) {
    ...
    (function (BasicSamples) {
        ...
        }(Serene1AspCore.Northwind.SupplierDialog));
...
(function (Serene1AspCore) {
    ...
    (function (BasicSamples) {
        ...
        var ReadOnlyGrid = /** @class */ (function (_super) {
            ...
            return ReadOnlyGrid;
        }(Serene1AspCore.Northwind.SupplierGrid));
...
(function (Serene1AspCore) {
    ...
    (function (BasicSamples) {
        ...
        var ResponsiveDialog = /** @class */ (function (_super) {
            ...
            ResponsiveDialog.prototype.getFormKey = function () { return Serene1AspCore.Northwind.OrderForm.formKey; };
            ResponsiveDialog.prototype.getIdProperty = function () { return Serene1AspCore.Northwind.OrderRow.idProperty; };
            ResponsiveDialog.prototype.getLocalTextPrefix = function () { return Serene1AspCore.Northwind.OrderRow.localTextPrefix; };
            ResponsiveDialog.prototype.getNameProperty = function () { return Serene1AspCore.Northwind.OrderRow.nameProperty; };
            ResponsiveDialog.prototype.getService = function () { return Serene1AspCore.Northwind.OrderService.baseUrl; };
...
(function (Serene1AspCore) {
    ...
    (function (BasicSamples) {
        var SerialAutoNumberDialog = /** @class */ (function (_super) {
            ...
            SerialAutoNumberDialog.prototype.getNextNumber = function () {
                ...
                if (!val || val.length <= 1) {
                    ...
                    Serene1AspCore.Northwind.CustomerService.GetNextNumber({
                        Prefix: prefix,
        ...
        }(Serene1AspCore.Northwind.CustomerDialog));
...
(function (Serene1AspCore) {
    ...
    (function (BasicSamples) {
        ...
        }(Serene1AspCore.Northwind.CustomerGrid));
        ...
        var ChangingLookupTextDialog = /** @class */ (function (_super) {
            ...
            function ChangingLookupTextDialog() {
                ...
                _this.form.ProductID.changeSelect2(function (e) {
                    var productID = Q.toId(_this.form.ProductID.value);
                    if (productID != null) {
                        _this.form.UnitPrice.value = Serene1AspCore.Northwind.ProductRow.getLookup().itemById[productID].UnitPrice;
                    }
                });
                _this.form.Discount.addValidationRule(_this.uniqueName, function (e) {
                    var price = _this.form.UnitPrice.value;
            ...
            ChangingLookupTextDialog.prototype.getLocalTextPrefix = function () { return Serene1AspCore.Northwind.OrderDetailRow.localTextPrefix; };
    ...
    (function (BasicSamples) {
        ...
        var ChangingLookupTextEditor = /** @class */ (function (_super) {
            ...
            ChangingLookupTextEditor.prototype.getLookupKey = function () {
                return Serene1AspCore.Northwind.ProductRow.lookupKey;
            };
    ...
    (function (BasicSamples) {
        ...
        var FilteredLookupOrderDetailDialog = /** @class */ (function (_super) {
            ...
            function FilteredLookupOrderDetailDialog() {
                var _this = _super.call(this) || this;
                _this.form = new Serene1AspCore.Northwind.OrderDetailForm(_this.idPrefix);
        ...
        }(Serene1AspCore.Northwind.OrderDetailDialog));
...
(function (Serene1AspCore) {
    ...
    (function (BasicSamples) {
        ...
        }(Serene1AspCore.Northwind.OrderDetailsEditor));
...
(function (Serene1AspCore) {
    ...
    (function (BasicSamples) {
        ...
        var FilteredLookupInDetailDialog = /** @class */ (function (_super) {
            ...
            FilteredLookupInDetailDialog.prototype.getIdProperty = function () { return Serene1AspCore.Northwind.OrderRow.idProperty; };
            FilteredLookupInDetailDialog.prototype.getLocalTextPrefix = function () { return Serene1AspCore.Northwind.OrderRow.localTextPrefix; };
            FilteredLookupInDetailDialog.prototype.getNameProperty = function () { return Serene1AspCore.Northwind.OrderRow.nameProperty; };
            FilteredLookupInDetailDialog.prototype.getService = function () { return Serene1AspCore.Northwind.OrderService.baseUrl; };
    ...
    (function (BasicSamples) {
        ...
        var ProduceSeafoodCategoryEditor = /** @class */ (function (_super) {
            ...
            ProduceSeafoodCategoryEditor.prototype.getLookupKey = function () {
                return Serene1AspCore.Northwind.CategoryRow.lookupKey;
            };
            /**
...
(function (Serene1AspCore) {
    ...
    (function (BasicSamples) {
        ...
        }(Serene1AspCore.Common.BulkServiceAction));
...
(function (Serene1AspCore) {
    ...
    (function (BasicSamples) {
        var ConditionalFormattingGrid = /** @class */ (function (_super) {
            ...
            ConditionalFormattingGrid.prototype.getDialogType = function () { return Serene1AspCore.Northwind.ProductDialog; };
            ConditionalFormattingGrid.prototype.getIdProperty = function () { return Serene1AspCore.Northwind.ProductRow.idProperty; };
            ConditionalFormattingGrid.prototype.getLocalTextPrefix = function () { return Serene1AspCore.Northwind.ProductRow.localTextPrefix; };
            ConditionalFormattingGrid.prototype.getService = function () { return Serene1AspCore.Northwind.ProductService.baseUrl; };
            /**
            ...
            CustomLinksInGrid.prototype.onClick = function (e, row, cell) {
                ...
                if (target.hasClass("customer-link")) {
                    ...
                    Q.confirm(message, function () {
                        ...
                        var customer = Q.first(Serene1AspCore.Northwind.CustomerRow.getLookup().items, function (x) { return x.CustomerID == item.CustomerID; });
                        new Serene1AspCore.Northwind.CustomerDialog().loadByIdAndOpenDialog(customer.ID);
                    }, {
                        htmlEncode: false,
                        onNo: function () {
                            new Serene1AspCore.Northwind.OrderDialog().loadByIdAndOpenDialog(item.OrderID);
                        }
                    });
                }
                    ...
                    new Serene1AspCore.Northwind.OrderDialog().loadEntityAndOpenDialog({
...
(function (Serene1AspCore) {
    ...
    Serene1AspCore.SelectableEntityGrid = SelectableEntityGrid;
})(Serene1AspCore || (Serene1AspCore = {}));
...
(function (Serene1AspCore) {
    ...
    (function (BasicSamples) {
        var RowSelectionGrid = /** @class */ (function (_super) {
            ...
            RowSelectionGrid.prototype.getDialogType = function () { return Serene1AspCore.Northwind.SupplierDialog; };
            RowSelectionGrid.prototype.getIdProperty = function () { return Serene1AspCore.Northwind.SupplierRow.idProperty; };
            RowSelectionGrid.prototype.getLocalTextPrefix = function () { return Serene1AspCore.Northwind.SupplierRow.localTextPrefix; };
            RowSelectionGrid.prototype.getService = function () { return Serene1AspCore.Northwind.SupplierService.baseUrl; };
            RowSelectionGrid = __decorate([
                Serenity.Decorators.registerClass()
            ], RowSelectionGrid);
            return RowSelectionGrid;
        }(Serene1AspCore.SelectableEntityGrid));
        ...
        var InitialValuesForQuickFilters = /** @class */ (function (_super) {
            ...
            InitialValuesForQuickFilters.prototype.getQuickFilters = function () {
                ...
                Q.first(filters, function (x) { return x.field == "ShippingState" /* ShippingState */; }).init = function (w) {
                    ...
                    w.value = Serene1AspCore.Northwind.OrderShippingState.NotShipped.toString();
                };
                return filters;
            };
            /**
                ...
                if (target.hasClass('inline-action')) {
                    ...
                    if (target.hasClass('delete-row')) {
                        Q.confirm('Delete record?', function () {
                            Serene1AspCore.Northwind.CustomerService.Delete({
                                EntityId: item.ID,
                            }, function (response) {
                                _this.refresh();
                            });
...
(function (Serene1AspCore) {
    ...
    (function (BasicSamples) {
        var InlineImageInGrid = /** @class */ (function (_super) {
            ...
            InlineImageInGrid.prototype.getDialogType = function () { return Serene1AspCore.Northwind.ProductDialog; };
            InlineImageInGrid.prototype.getIdProperty = function () { return Serene1AspCore.Northwind.ProductRow.idProperty; };
            InlineImageInGrid.prototype.getLocalTextPrefix = function () { return Serene1AspCore.Northwind.ProductRow.localTextPrefix; };
            InlineImageInGrid.prototype.getService = function () { return Serene1AspCore.Northwind.ProductService.baseUrl; };
...
(function (Serene1AspCore) {
    ...
    (function (BasicSamples) {
        var QuickFilterCustomization = /** @class */ (function (_super) {
            ...
            QuickFilterCustomization.prototype.getDialogType = function () { return Serene1AspCore.Northwind.OrderDialog; };
            QuickFilterCustomization.prototype.getIdProperty = function () { return Serene1AspCore.Northwind.OrderRow.idProperty; };
            QuickFilterCustomization.prototype.getLocalTextPrefix = function () { return Serene1AspCore.Northwind.OrderRow.localTextPrefix; };
            QuickFilterCustomization.prototype.getService = function () { return Serene1AspCore.Northwind.OrderService.baseUrl; };
            /**
             * This method is called to get list of quick filters to be created for this grid.
             * By default, it returns quick filter objects corresponding to properties that
             * have a [QuickFilter] attribute at server side OrderColumns.cs
...
(function (Serene1AspCore) {
    ...
    (function (BasicSamples) {
        var CustomerGrossSalesGrid = /** @class */ (function (_super) {
            ...
            CustomerGrossSalesGrid.prototype.getNameProperty = function () { return Serene1AspCore.Northwind.CustomerGrossSalesRow.nameProperty; };
            CustomerGrossSalesGrid.prototype.getLocalTextPrefix = function () { return Serene1AspCore.Northwind.CustomerGrossSalesRow.localTextPrefix; };
...
(function (Serene1AspCore) {
    ...
    (function (BasicSamples) {
        var ViewWithoutIDGrid = /** @class */ (function (_super) {
            ...
            ViewWithoutIDGrid.prototype.getNameProperty = function () { return Serene1AspCore.Northwind.SalesByCategoryRow.nameProperty; };
            ViewWithoutIDGrid.prototype.getLocalTextPrefix = function () { return Serene1AspCore.Northwind.SalesByCategoryRow.localTextPrefix; };
            ViewWithoutIDGrid.prototype.getService = function () { return Serene1AspCore.Northwind.SalesByCategoryService.baseUrl; };
            /**
             * This method is called to preprocess data returned from the list service
             */
...
//# sourceMappingURL=Serene1AspCore.Web.js.map